...
class ExamPracticeDriver {
    public static void main(String[] args) {
        ...
        linkedList.remove(copy);

        System.out.printf("%nData: %s Size: %d %n", linkedList.toString(), linkedList.getSize());
        ...
        System.out.println();
        System.out.printf("Enter the index to insert new node [0-%d]: ", linkedList.getSize()-1);
        index = scan.nextInt();
